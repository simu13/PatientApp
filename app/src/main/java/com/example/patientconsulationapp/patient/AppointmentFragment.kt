...
import com.example.patientconsulationapp.adapter.TimesAdapter
...
class AppointmentFragment : Fragment(), View.OnClickListener {
    ...
    override fun onCreateView(
        ...
        dateSetListener = DatePickerDialog.OnDateSetListener { _, i, i2, i3 ->
            ...
            timeAdapter = activity?.let { it1 -> TimesAdapter(it1, ArrayList()) }!!
...
timeAdapter.setOnItemClickListener {
    Toast.makeText(requireContext(),"Clicked",Toast.LENGTH_SHORT).show()
        ...
        root.confirmButton.setOnClickListener {
            ...
            Navigation.findNavController(it).navigate(R.id.action_appointmentFragment_to_timeFragment2,bundle)
